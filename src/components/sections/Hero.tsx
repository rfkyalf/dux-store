  ...
  return (
    <div className="relative wrapper h-[400px] md:h-[300px] lg:h-fit bg-gradient-to-tr from-pink-400 via-pink-400 to-pink-300 my-4 flex flex-col rounded-xl">
      <div className="flex flex-col gap-y-2 lg:gap-y-3 p-4 md:p-6 lg:p-16 md:max-w-[400px] lg:max-w-[650px]">
        <h2 className="text-3xl lg:text-4xl font-bold text-transparent bg-gradient-to-r from-pink-900 via-pink-700 to-pink-600 bg-clip-text text-pretty">
        ...
        <button className="group w-fit bg-neutral-50 text-pink-600 text-base font-medium flex items-center gap-x-2 mt-4 lg:mt-6 rounded-lg px-6 py-2 focus:ring ring-pink-600 border-2 border-transparent hover:border-pink-600 transition duration-300">
